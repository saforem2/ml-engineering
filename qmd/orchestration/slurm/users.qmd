...
<<<<<<< HEAD:qmd/orchestration/slurm/users.qmd
## How to gracefully exit on SLURM job preemption

There are several ways to gracefully handle time- and QoS-based SLURM pre-emption which are covered indepth in this section: [Dealing with forced job preemption](https://saforem2.github.io/ml-engineering/qmd/training/fault-tolerance/#dealing-with-forced-resource-preemption)
=======
